          ...
          >
            ...
            <div className="input-group">
              ...
              <div className="pattern-grid">
                <button
                  className={`pattern-btn ${pattern === "dots" ? "active" : ""
                    }`}
                ...
                <button
                  className={`pattern-btn ${pattern === "rounded" ? "active" : ""
                    }`}
                ...
                <button
                  className={`pattern-btn ${pattern === "square" ? "active" : ""
                    }`}
                ...
                <button
                  className={`pattern-btn ${pattern === "extra-rounded" ? "active" : ""
                    }`}
                ...
                <button
                  className={`pattern-btn ${pattern === "classy" ? "active" : ""
                    }`}
